...
func latestRevisionCluster(packageSets []packagesv1alpha1.ClusterPackageSet) (int, error) {
...
func pausedObjectsFromClusterPackageSet(packageSet *packagesv1alpha1.ClusterPackageSet) ([]packagesv1alpha1.PackagePausedObject, error) {
